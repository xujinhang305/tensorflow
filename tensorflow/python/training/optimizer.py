...
class _DenseResourceVariableProcessor(_OptimizableVariable):
  ...
  def update_op(self, optimizer, g):
    ...
    if context.xla_sharding_for_resource_variables_enabled():
      ...
      # variables with XLA sharding are sharded correctly. Please see the design
      # at http://shortn/_1BAU64mLui for more details.
      assign_ops = []
      for _, variable_dict in optimizer._slots.items():
        for _, slot_var in variable_dict.items():
          if (
