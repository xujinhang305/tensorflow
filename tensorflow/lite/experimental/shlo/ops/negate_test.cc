...
template <class T>
struct NonQuantizedNegateTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedNegateTest, NonQuantizedTestTypes, TestParamNames);

TYPED_TEST(NonQuantizedNegateTest, ArithmeticTensorsWork) {
...
TYPED_TEST(QuantizedNegateTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
