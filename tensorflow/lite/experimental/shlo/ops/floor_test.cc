...
template <class T>
struct NonQuantizedIntFloorTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntFloorTest, NonQuantizedIntTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedIntFloorTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedFloorTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedFloorTest, NonQuantizedFloatTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedFloorTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedFloorTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
