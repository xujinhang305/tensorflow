...
template <class T>
struct NonQuantizedSignTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedSignTest, NonQuantizedTestTypes, TestParamNames);

TYPED_TEST(NonQuantizedSignTest, ArithmeticTensorsWork) {
...
TYPED_TEST(QuantizedSignTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
