...
template <class T>
struct NonQuantizedIntExponentialMinusOneTest : ::testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntExponentialMinusOneTest,
                 NonQuantizedIntTestTypes, TestParamNames);

TYPED_TEST(NonQuantizedIntExponentialMinusOneTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedExponentialMinusOneTest : ::testing::Test {};

TYPED_TEST_SUITE(NonQuantizedExponentialMinusOneTest,
                 NonQuantizedFloatTestTypes, TestParamNames);

TYPED_TEST(NonQuantizedExponentialMinusOneTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedExponentialMinusOneTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
