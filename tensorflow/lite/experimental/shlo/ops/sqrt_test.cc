...
template <class T>
struct NonQuantizedIntSqrtTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntSqrtTest, NonQuantizedIntTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedIntSqrtTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedSqrtTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedSqrtTest, NonQuantizedFloatTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedSqrtTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedSqrtTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
