...
template <class T>
struct NonQuantizedIntLogTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntLogTest, NonQuantizedIntTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedIntLogTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedLogTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedLogTest, NonQuantizedFloatTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedLogTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedLogTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
