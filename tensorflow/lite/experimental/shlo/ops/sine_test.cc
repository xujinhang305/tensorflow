...
template <class T>
struct NonQuantizedIntSineTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntSineTest, NonQuantizedIntTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedIntSineTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedSineTest : testing::Test {};

TYPED_TEST_SUITE(NonQuantizedSineTest, NonQuantizedFloatTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedSineTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedSineTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
