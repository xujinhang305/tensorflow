...
template <class T>
struct NonQuantizedIntLogPlusOneTest : ::testing::Test {};

TYPED_TEST_SUITE(NonQuantizedIntLogPlusOneTest, NonQuantizedIntTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedIntLogPlusOneTest, IntTensorsRaiseAnError) {
...
template <class T>
struct NonQuantizedLogPlusOneTest : ::testing::Test {};

TYPED_TEST_SUITE(NonQuantizedLogPlusOneTest, NonQuantizedFloatTestTypes,
                 TestParamNames);

TYPED_TEST(NonQuantizedLogPlusOneTest, FloatTensorsWork) {
  using StorageT = typename TypeParam::StorageT;
...
TYPED_TEST(QuantizedLogPlusOneTest, PerAxisFails) {
  using StorageT = typename TypeParam::StorageT;
  using ExpressedT = typename TypeParam::ExpressedT;
