...
HloInstruction& FuseDot(const HloDotInstruction& dot,
                        ...
                        const HloInstruction* fused_meta,  // optional
  ...
  if (fused_meta != nullptr) {
    hlo_new_operands.push_back(const_cast<HloInstruction*>(fused_meta));
  }
